...
export const GENERAL_FILTERS = {
  conditions: ['Mới 100%', 'Hoạt động tốt', 'Hư nhẹ', 'Hư nặng', 'Xác/Đồng nát'],
  priceRanges: ['Dưới 500k', '500k - 2 Triệu', '2 Triệu - 5 Triệu', 'Trên 5 Triệu'],
  priorities: ['Bán gấp', 'Thanh lý số lượng lớn'],
};

export const SPECIFIC_FILTERS = {
  dien_may: {
    types: ['Tủ lạnh', 'Máy giặt', 'Lò vi sóng', 'Máy lạnh', 'Tivi', 'Quạt', 'Máy hút bụi'],
  ...
  noi_that: {
    ...
    materials: ['Gỗ tự nhiên', 'Gỗ công nghiệp', 'Kim loại', 'Nhựa', 'Sofa/Nỉ', 'Da'],
  },
  sinh_hoat: {
