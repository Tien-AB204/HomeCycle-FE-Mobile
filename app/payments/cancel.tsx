      ...
      <View style={styles.container}>
        <View style={styles.card}>
          ...
          <Text style={styles.subtitle}>
            Giao dịch chưa được hoàn tất. Bạn có thể thử lại hoặc quay lại phòng chat để thảo luận thêm.
          </Text>
          ...
          {loading ? (
            ...
            <View style={styles.btnContainer}>
              ...
              <TouchableOpacity style={styles.secondaryBtn} onPress={handleGoToChat}>
              ...
              <TouchableOpacity style={styles.outlineBtn} onPress={handleGoHome}>
                <Ionicons name="home-outline" size={18} color={COLORS.textLight} style={{ marginRight: 8 }} />
