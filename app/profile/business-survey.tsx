...
const styles = StyleSheet.create({
  ...
  sectionTitle: { color: "#172830", fontSize: 14, fontWeight: "800", flex: 1 },
  ...
  chipSelected: { borderColor: "rgba(84, 123, 125, 0.24)", backgroundColor: "rgba(84, 123, 125, 0.10)" },
  chipText: { color: COLORS.text, fontSize: 12, fontWeight: "600" },
  chipTextSelected: { color: "#2B5659" },
  addCityButton: {
    minHeight: 42,
    borderWidth: 1,
  ...
  optionBoxActive: { borderColor: COLORS.primary, backgroundColor: "rgba(84, 123, 125, 0.10)" },
  optionText: { flex: 1, color: COLORS.text, fontSize: 13 },
  optionTextActive: { color: "#2B5659", fontWeight: "700" },
