            ...
            <View style={styles.formContainer}>
              ...
              {model === 'household' && (
                <>
                  ...
                  <TextInput style={styles.input} placeholder="Nhập tên đăng ký kinh doanh" />
                  <Text style={styles.label}>Mã số thuế hộ kinh doanh</Text>
                  <TextInput style={styles.input} placeholder="Nhập 10 hoặc 13 số" keyboardType="numeric" />
                  <Text style={styles.label}>Địa chỉ, địa điểm kinh doanh cố định</Text>
                  <TextInput style={[styles.input, styles.textArea]} placeholder="Số nhà, tên đường, phường/xã..." multiline />

                  <SectionHeader title="THÔNG TIN CHỦ HỘ" />
                  <Text style={styles.label}>Họ và tên chủ hộ kinh doanh</Text>
                  <TextInput style={styles.input} placeholder="NHẬP ĐẦY ĐỦ HỌ VÀ TÊN" autoCapitalize="characters" />
                  ...
                  <TextInput style={styles.input} placeholder="Nhập số căn cước công dân" keyboardType="numeric" />

                  <SectionHeader title="HỒ SƠ PHÁP LÝ" />
                  <Text style={styles.label}>Giấy chứng nhận đăng ký hộ kinh doanh</Text>
                  <UploadBox icon="cloud-upload-outline" text="Tải lên file ảnh hoặc PDF (tối đa 10MB)" />
                  ...
                  <View style={styles.paymentBox}>
                    ...
                    <TextInput style={styles.inputPayment} placeholder="VD: Vietcombank, Techcombank..." />
                    <Text style={styles.label}>Số tài khoản</Text>
                    <TextInput style={styles.inputPayment} placeholder="Nhập số tài khoản ngân hàng" keyboardType="numeric" />
                    <Text style={styles.label}>Tên chủ tài khoản (Phải khớp với tên ĐN/Đại diện)</Text>
                    <TextInput style={styles.inputPayment} placeholder="VD: NGUYEN VAN A" autoCapitalize="characters" />
                  </View>
                </>
              )}
              ...
              {model === 'enterprise' && (
                <>
                  ...
                  <TextInput style={styles.input} placeholder="VD: Công ty TNHH HomeCycle Việt Nam" />
                  <Text style={styles.label}>Mã số thuế doanh nghiệp</Text>
                  <TextInput style={styles.input} placeholder="10 chữ số hoặc 13 chữ số" keyboardType="numeric" />
                  ...
                  <TextInput style={[styles.input, styles.textArea]} placeholder="Nhập địa chỉ kho tập kết hàng hóa" multiline />

                  <SectionHeader title="THÔNG TIN NGƯỜI ĐẠI DIỆN" />
                  <Text style={styles.label}>Họ và tên người đại diện</Text>
                  <TextInput style={styles.input} placeholder="Nhập đầy đủ họ và tên" />
                  <View style={styles.row}>
                    <View style={{ flex: 1, marginRight: 8 }}>
                    ...
                    <View style={{ flex: 1, marginLeft: 8 }}>
                      <Text style={styles.label}>Số CCCD/CMND</Text>
                      <TextInput style={styles.input} placeholder="Số định danh" keyboardType="numeric" />
                    </View>
                  </View>

                  <SectionHeader title="HỒ SƠ PHÁP LÝ" />
                  <Text style={styles.label}>Giấy chứng nhận đăng ký doanh nghiệp</Text>
                  <UploadBox icon="cloud-upload-outline" text="Tải lên file ảnh hoặc PDF (tối đa 10MB)" />
                  ...
                  <View style={styles.rowBetween}>
                    <Text style={styles.label}>Giấy ủy quyền + CCCD người được ủy quyền</Text>
                    <Text style={styles.helperText}>(Tùy chọn)</Text>
                  </View>
                  <UploadBox icon="attach-outline" text="Kéo thả file vào đây để đính kèm" />
              ...
              <TouchableOpacity style={styles.submitButton} onPress={handleSubmit}>
                <Text style={styles.submitButtonText}>Gửi yêu cầu <Ionicons name="send" size={14} /></Text>
              </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  dropdown: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', borderWidth: 1, borderColor: COLORS.border, borderRadius: 8, paddingHorizontal: 12, height: 48, backgroundColor: COLORS.white },
  dropdownText: { fontSize: 14, color: COLORS.textLight },
  
  // Upload Box
  uploadBox: { borderWidth: 1.5, borderColor: COLORS.border, borderStyle: 'dashed', borderRadius: 8, padding: 16, alignItems: 'center', justifyContent: 'center', marginBottom: 16, backgroundColor: '#FAFAFA' },
