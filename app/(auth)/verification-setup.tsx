...
export default function VerificationSetupScreen() {
  ...
  const handleComplete = () => {
    console.log("Dữ liệu gửi lên:", { bankName, bankAccount, bankAccountName, frontImage, backImage });
      ...
      >
        ...
        <ScrollView contentContainerStyle={styles.scrollContainer} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.cccdContainer}>
            ...
            <TouchableOpacity style={styles.cccdUploadBox} onPress={() => pickImage('front')}>
              {frontImage ? (
            ...
            <TouchableOpacity style={styles.cccdUploadBox} onPress={() => pickImage('back')}>
              {backImage ? (
          ...
          <View style={styles.paymentWrapper}>
            ...
            <Text style={styles.fieldLabel}>Tên chủ tài khoản (Phải khớp với CCCD)</Text>
            <View style={styles.inputContainerWhite}>
              <TextInput
                style={[styles.input, Platform.OS === 'web' && { outlineStyle: 'none' } as any]}
...
const styles = StyleSheet.create({
  ...
  cccdUploadBox: { 
    flex: 1, height: 100, borderWidth: 1, borderColor: '#E2E8F0', 
    borderStyle: 'dashed', borderRadius: 8, justifyContent: 'center', 
    alignItems: 'center', backgroundColor: '#FAFAFA', overflow: 'hidden' // overflow hidden để ảnh không tràn ra ngoài góc bo
  },
