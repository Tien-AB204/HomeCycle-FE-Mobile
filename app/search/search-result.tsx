    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.sortBar}>
        <ScrollView
          ...
          contentContainerStyle={styles.sortTabsWrapper}
        >
          {sortOptions.map((opt) => (
            <TouchableOpacity
              key={opt}
              style={[
                styles.sortTab,
                selectedSort === opt && styles.sortTabActive,
              ]}
            ...
            >
              <Text
                style={[
                  styles.sortTabText,
                  selectedSort === opt && styles.sortTabTextActive,
                ]}
              >
                {opt}
              </Text>
        ...
        <View style={isGridView ? styles.gridContainer : styles.listContainer}>
          {sellingPosts.map((post) => (
            ...
            >
              <View
                style={
                  isGridView ? styles.gridImageWrapper : styles.listImageWrapper
                }
              >
                <Image
...
const styles = StyleSheet.create({
  ...
  searchBarContainer: {
    ...
    width: "100%", // Căng tràn 100% trong khung centerContent
  },
