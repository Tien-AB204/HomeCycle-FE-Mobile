...
const MOCK_CHATS = [
  {
    ...
    role: "personal",
    avatar:
      "https://ui-avatars.com/api/?name=Minh+Anh&background=2B5659&color=fff",
    lastMessage: "Bạn có thể giảm giá chiếc xe đạp này không?",
    time: "14:20",
    unread: 2,
  },
  {
    id: "2",
    name: "Cơ điện lạnh ABC",
    role: "business",
    avatar: "https://ui-avatars.com/api/?name=ABC&background=547B7D&color=fff",
    lastMessage: "Chúng tôi chốt giá 1.500.000đ nhé.",
    time: "12:05",
    unread: 0,
  },
  {
    ...
    name: "Hoàng Yến",
    role: "personal",
    avatar: "https://ui-avatars.com/api/?name=Yen&background=BAC2C1&color=fff",
    lastMessage: "Sản phẩm này còn bảo hành không ạ?",
    time: "Hôm qua",
    unread: 1,
  },
  {
    ...
    name: "Lê Hùng",
    role: "personal",
    avatar: "https://ui-avatars.com/api/?name=Hung&background=2B5659&color=fff",
    lastMessage: "Ok, hẹn gặp bạn lúc 5h chiều nay nhé.",
    time: "Thứ 2",
    unread: 0,
  },
];
    ...
    >
      ...
      <View style={styles.chatInfo}>
        <View style={styles.nameRow}>
          <Text
            style={[styles.chatName, item.unread > 0 && styles.textBold]}
            numberOfLines={1}
          >
            {item.name}
          </Text>
