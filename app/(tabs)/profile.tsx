...
export default function ProfileScreen() {
      ...
      <SafeAreaView style={styles.safeArea}>
        <View style={[styles.mobileWrapper, { width }]}>
          ...
          <View style={styles.unauthContainer}>
            <Ionicons name="person-circle-outline" size={80} color="#CBD5E1" style={{ marginBottom: 16 }} />
            <Text style={styles.unauthTitle}>Bạn chưa đăng nhập</Text>
            <Text style={styles.unauthDesc}>
              Đăng nhập để cập nhật hồ sơ, theo dõi ví tiền và tận hưởng đầy đủ tiện ích của HomeCycle!
            </Text>
            <TouchableOpacity
              style={styles.loginBtn}
              onPress={() => router.push("/(auth)/login?returnUrl=/(tabs)/profile")}
            >
  ...
  const menuItems =
    user.role === "business"
      ...
      : [
          { icon: "person-outline", title: "Thông tin tài khoản", route: "/profile/account-info" },
        ...
        <ScrollView showsVerticalScrollIndicator={false} style={styles.container}>
            ...
            <View style={styles.upgradeBanner}>
              <View style={styles.upgradeTextContainer}>
                ...
                <Text style={styles.upgradeDesc}>
                  Tăng độ uy tín, mở rộng hạn mức đăng tin và nhận hỗ trợ ưu tiên.
                </Text>
          ...
          <View style={styles.statsGrid}>
            ...
            <View style={styles.statCard}>
              ...
              <Text style={styles.statLabel}>{user.role === "business" ? "Tin đang thu mua" : "Tin đang đăng bán"}</Text>
...
const styles = StyleSheet.create({
  ...
  unauthContainer: { flex: 1, justifyContent: "center", alignItems: "center", padding: 24, backgroundColor: COLORS.background, },
